...
class JexchooseModelItem extends JModelAdmin
{
	/**
	...
	*/
	public function getTable($type = 'Items', $prefix = 'JexchooseTable', $config = array())
	{
	...
	*/
	...
	{
		//get the form
		$form = $this->loadForm('com_jexchoose.item', 'item', array('control'=>'jform', 'load_data'=>$loadData));
		if(empty($form))
		{
			return false;
		}
	...
	*/
	...
	{
		return 'administrator/components/com_jexchoose/models/forms/item.js';
	}
	/**
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jexchoose.edit.item.data', array());
		if(empty($data))
		{
			$data = $this->getItem();
		}
